...
| Supabase 운영 DB 상태 점검 SQL을 확인할 때 | `docs/supabase_db_health_queries.md` |
...
| 7번 Supabase 운영 전환 | `docs/cloud_operations_migration_plan.md`, `docs/supabase_db_health_queries.md`, `docs/daily_automation.md`, `docs/automation_room_handoff.md` |
...
| `D:\Project\3_safetyzone_monitoring_system` | `docs/supabase_db_health_queries.md` | Supabase 운영 DB 용량, 현재 객체, 실행 이력, 변경 이벤트 점검 SQL |
...
- `docs/supabase_db_health_queries.md`: Supabase 운영 DB 상태 점검 SQL
...
- `docs/supabase_db_health_queries.md`: Supabase 운영 DB 용량, 현재 데이터, 모니터링 이력 점검 SQL
...
3. `docs/supabase_db_health_queries.md`
4. `docs/supabase_snapshot_retention_and_monthly_archive.md`
5. `.github/workflows/daily-monitor.yml`
6. `docs/automation_room_handoff.md`
